...
| `jlegroup.EPQ03` | Elliot, Person & Qu (2003), AJ 126, 1041 — light-curve **inversion** & atmospheric retrieval with error propagation, plus optional **ratchet binning** (concept: W. Saunders) for honest deep-profile statistics on low-S/N curves | ✅ implemented & validated |
